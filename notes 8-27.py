# -*- coding: utf-8 -*-
"""
Created on Fri Aug 27 10:53:28 2021
...
#total spent isa bad variable because of the space
...
# Both answers should be to 4 decimal places printed. 
...
radius = input("Waht is the radius of your sphere? ")
